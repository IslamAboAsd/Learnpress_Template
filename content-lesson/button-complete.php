...
<form method="post" name="learn-press-form-complete-lesson"
	...
	<?php if ( $completed ) { ?>
        ...
        <p><i class="fa fa-check"></i> <?php echo esc_html__( 'Completed', 'kipso' ); ?></p>
	...
	<?php } else { ?>
        ...
        <button class="lp-button button button-complete-item button-complete-lesson"><?php echo esc_html__( 'Complete', 'kipso' ); ?></button>
