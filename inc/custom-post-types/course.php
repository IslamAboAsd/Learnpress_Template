...
//						)
					...
					array(
						'name'        => __( 'عنوان الورشة', 'learnpress' ),
						'id'          => '_lp_location',
						'type'        => 'wysiwyg',
						'desc'        => __( 'عنوان الورشة', 'learnpress' ),
						'placeholder' => 'بمنطقة جدة',
						'roles'       => 'administrator' // Admin only
					),
					array(
						'name'        => __( 'وقت الورشة', 'learnpress' ),
						'id'          => '_lp_time',
						'type'        => 'wysiwyg',
						'desc'        => __( 'عنوان الورشة', 'learnpress' ),
						'placeholder' => 'من الساعة 12 إلى الساعة 2',
						'roles'       => 'administrator' // Admin only
					),
					array(
						'name'        => __( 'وقت بدأ الورشة', 'learnpress' ),
						'id'          => '_lp_start',
						'type'        => 'wysiwyg',
						'desc'        => __( 'وقت بدأ الورشة', 'learnpress' ),
						'placeholder' => 'من يوم 12 -12-2020 إلى يوم02',
						'roles'       => 'administrator' // Admin only
					),
					array(
