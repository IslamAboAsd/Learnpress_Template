...
<p><?php echo sprintf( esc_html__( 'Hello <strong>%s</strong> (not %s? %s)', 'kipso' ), $user->get_display_name(), $user->get_display_name(), sprintf( '<a href="%s">%s</a>', $profile->logout_url(), esc_html__( 'Sign out', 'kipso' ) ) ); ?></p>