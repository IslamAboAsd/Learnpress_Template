...
<div class="section-header">
    ...
    <div class="section-left">
		...
		<?php if ( $title ) { ?>
            <h5 class="section-title"><?php echo esc_html($title); ?></h5>
		<?php } ?>

		<?php if ( $description = $section->get_description() ) { ?>
            <p class="section-desc"><?php echo wp_kses($description, true); ?></p>
		<?php } ?>
	...
	<?php if ( $user->has_enrolled_course( $section->get_course_id() ) ) { ?>
        ...
        <div class="section-meta">
            ...
            <span class="step"><?php printf( esc_html__( '%d/%d', 'kipso' ), $user_course->get_completed_items( '', false, $section->get_id() ), $section->count_items( '', false ) ); ?></span>
