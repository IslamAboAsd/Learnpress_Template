...
<div class="learn-press-content-protected-message">
    ...
    if( $can_view_item && $can_view_item == 'not-enrolled' ){
	    echo apply_filters( 'learn_press_content_item_protected_message',
		    esc_html__( 'This content is protected, please enroll course to view this content!', 'kipso' ) );
	    learn_press_course_enroll_button();
    } else{
	    echo apply_filters( 'learn_press_content_item_protected_message',
		    sprintf( esc_html__( 'This content is protected, please <a href="%s">login</a> and enroll course to view this content!', 'kipso' ), learn_press_get_login_url( learn_press_get_current_url() ) ) );
